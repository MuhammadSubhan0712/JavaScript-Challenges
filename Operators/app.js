...
console.log("Using Assignment Operator the sum of " , num1 , " & " , num2 , " += " , sum);
...
console.log("Using Assignment Operator the subtraction of ",num3, " & ", num4 ," -= ",chk);
...
numbers < 0 ? console.log("Number is Negative" , " : " , numbers) : console.log("Number is positive" , " : " , numbers);

let numbers1 = -325;

numbers1 < 0 ? console.log("Number is Negative" , " : " , numbers1) : console.log("Number is positive" , " : " , numbers1);
